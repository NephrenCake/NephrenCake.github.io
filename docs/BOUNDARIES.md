...
This file is the authoritative **area-to-gem** table. For how the pieces connect at runtime — the wrapper/tag/gem delegation map, silent feature gating, and the v1 config contract — see [`ARCHITECTURE.md`](ARCHITECTURE.md).
